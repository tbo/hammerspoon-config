   ...
   if win then
      ...
      if app then
         if app:bundleID() == 'com.brave.Browser' then
            stopObservers()
            hs.eventtap.event.newKeyEvent({"shift", "alt"}, 'J', true):post()
            startObservers()
         else 
...
function sendPreviousKey() 
   ...
   if win then
      ...
      if app then
         if app:bundleID() == 'com.brave.Browser' then
            stopObservers()
            hs.eventtap.event.newKeyEvent({"shift", "alt"}, 'K', true):post()
            startObservers()
         else 
